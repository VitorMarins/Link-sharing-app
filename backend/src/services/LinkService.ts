import type { ILinksRepository, CreateLinkData, UpdateLinkData } from '../repositories/ILinkRepository';
import { UserService } from './UserService';

export class LinkService {
    constructor(private linksRepository: ILinksRepository, private userService: UserService) {}
